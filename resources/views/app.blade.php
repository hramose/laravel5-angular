	            ...
	            <ul class="nav navbar-top-links navbar-right">
	                <li class="dropdown">
	                    ...
	                    <ul class="dropdown-menu dropdown-user">
	                        <li><a href="{{ URL::route('logout') }}">{{ trans('app.settings') }}</a></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu" ng-controller="NavController as nav">
                        ...
                        <li ng-repeat="n in nav.routes track by $index" ng-init='menuNum=$index'>
                            ...
                            <ul ng-show='n.subMenu !== undefined' id="sub<% $index+1 %>" class="nav nav-second-level collapse out">
                            	<li ng-repeat="s in n.subMenu track by $index">
